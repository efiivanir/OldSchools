...
#define ValidateRead(read_parameters,required_parameters,ErrorString)   \
...
#ifdef DEBUG
    cout << "OnAddFruit" << endl;
    cout << i << " " << j << " " << fruitID << " " << ripeRate << endl;
#endif   
    printf("AddFruit: %s\n", ReturnValToStr(res));
    cout << "-------------------------------------------------------" << endl;
    return error_free;
...
#ifdef DEBUG
    cout << "OnRateFruit" << endl;
    cout << fruitID << " " << ripeRate << endl;
#endif   
    printf("RateFruit: %s\n", ReturnValToStr(res));
    cout << "-------------------------------------------------------" << endl;
    return error_free;
  ...
  void PrintAll(int *fruits, int *rate_fruits, int numOfFruits) {
    if (numOfFruits > 0) {
      cout << "Rank	||	Fruit	||	Rate     ||" << endl;
    }

    for (int i = 0; i < numOfFruits; i++) {
      cout << i + 1 << "\t||\t" << fruits[i] << "\t||\t" << rate_fruits[i]  << endl;
    }
  ...
  static errorType OnGetAllFruitsByRate(void* DS, const char* const command) {
    ...
    int *rate_fruits;
    int numOfFruits;
    StatusType res = GetAllFruitsByRate(DS, i,j, &fruits, &rate_fruits, &numOfFruits);
    ...
    PrintAll(fruits, rate_fruits,numOfFruits);
    cout << "-------------------------------------------------------" << endl;
    return error_free;
  }
...
#ifdef DEBUG
    cout << "OnUpdateRottenFruits" << endl;
    cout << rottenBase << " " << rottenFactor << endl;
#endif   
    printf("UpdateRottenFruits: %s\n", ReturnValToStr(res));
    cout << "-------------------------------------------------------" << endl;
    return error_free;
